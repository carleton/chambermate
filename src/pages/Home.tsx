...
export function ChamberMate() {
    ...
    const renderCopPage = () => (
        <div>
            ...
            <h1><center>{experimentTitle} COP</center></h1>
            <div>
                <button onClick={() => setCurrentPage("pageone")} style={{ width: '100%', marginBottom: '1rem' }} className="ui-btn ui-icon-carat-l ui-btn-icon-left back-btn">
                    Back
                </button>
                <center>COP Test</center>
                ...
                <table className="scaled-table">
                    <tr>
                        ...
                        <td>
                            <span
                                id="in_obj_1"
                                style={{ color: withOne ? 'magenta' : 'white', marginRight: '20px' }}
                        ...
                        <td>
                            <span
                                id="center_purple"
                                style={{ color: withCenter ? 'magenta' : 'white', marginRight: '20px' }}
                                className="locationText"
                            >
                                Center
                            </span>
                        ...
                        <td>
                            <span
                                id="in_obj_2"
                                style={{ color: withTwo ? 'magenta' : 'white' }}
                                className="locationText"
                            >
                                {objTwo}
                            </span>
                    ...
                    <tr>
                        <td><button onClick={startCop}>Start COP</button></td>
                        <td></td>
                        <td></td>
                        <td></td>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td><button onClick={flagCop}>Flag</button></td>
                        <td></td>
                        <td>
                            <button
                                id="download-csv"
                                className="ui-btn ui-icon-action ui-btn-icon-right"
                ...
                {/* <div style={{ marginBottom: '10px' }}>
                    <span id="in_obj_1" style={{ color: withOne ? 'magenta' : 'white', marginRight: '20px' }}>
                        {objOne}
                    </span>
                    <span id="center_purple" style={{ color: withOne ? 'magenta' : 'white', marginRight: '20px' }}>Center</span>
                    <span id="in_obj_2" style={{ color: withTwo ? 'magenta' : 'white' }}>
                        {objTwo}
                    </span>
                </div> */}
                {/* <div style={{ marginBottom: '10px' }}>
