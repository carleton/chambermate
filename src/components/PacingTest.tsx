  ...
  return (
    <div className="min-h-screen bg-black text-white p-4">
      <div className="bg-primary text-white p-4 mb-4">
        <h1 className="text-2xl font-bold">Pacing Test</h1>
      ...
      <div className="text-center">
        <h2 className="text-xl mb-4">Pacing Test Interface</h2>
        <p className="mb-4">
          This is where the pacing test will be implemented.
        </p>
        ...
        <div className="bg-gray-800 p-4 rounded">
          ...
          <p>Stud Number: {experimentData.studNumber}</p>
